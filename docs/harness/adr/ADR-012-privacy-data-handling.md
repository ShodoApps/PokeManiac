...
PokeManiac stores and transmits personal data: profile photos, usernames, friend relationships, transaction history (cards traded, prices). This data is subject to GDPR (EU users) and similar regulations.
