...
ADRs document the reasoning behind architectural decisions in PokeManiac. Before questioning or changing an architectural decision, check the index below.
