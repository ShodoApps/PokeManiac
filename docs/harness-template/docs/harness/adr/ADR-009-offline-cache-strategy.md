...
[PROJECT_NAME] runs on mobile devices with unreliable connectivity. Users expect to see content even when offline or on a slow network. Without a cache, every lost connection results in an empty screen.
