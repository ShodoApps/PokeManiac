...
[PROJECT_NAME] targets a mobile audience. Accessibility is a legal requirement in most markets and improves usability for all users (e.g. poor lighting, one-handed use, large text preferences).
...
- Text contrast meets WCAG AA minimum (4.5:1 for normal text, 3:1 for large text) — enforced by design token choice in `[PROJECT_NAME]Color.kt`
