...
- ⏳ **Next** — **Phase F** (in progress: Search Friend + **My Friends** migrated; remaining features → shared `ScreenModel`; then single Android app module shape, **TBD**), then **Phase G** (iOS app, Apple targets, SwiftUI, iOS Koin).
